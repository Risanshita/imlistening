...
const CreateUrl = ({ isOpen, onClose, editData }) => {
    ...
    function handleLoadTesting(value) {
        console.log("Load testing value " + value);
        setIsLoadTesting(!isLoadTesting);
    }
    return (
        <>
            {" "}
            ...
            >
                <div style={{ padding: 0 }}>
                    ...
                    >
                        ...
                        >
                            <div>
                                <Checkbox onChange={handleLoadTesting}>Load Testing</Checkbox>
                            </div>
                        </Form.Item>
                        {(isLoadTesting) ? null :
